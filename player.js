...
function togglePlay() {
    if (video.paused) {
        ...
        video.play().catch(() => {});
        forceLandscapeAndFullscreen();  // Forzar horizontal al reproducir
    } else {
        video.pause();
    }
}
...
function initPlayer() {
    ...
    video.addEventListener("timeupdate", () => {
        ...
        if (!saveInterval) saveInterval = setInterval(saveProgress, 1000);
    });
    ...
    // Intento extra al tocar la pantalla
